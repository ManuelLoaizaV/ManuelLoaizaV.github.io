...
<section class="layout-md py-12">
  <p class="text-lg mb-4">
    I am interested in most areas of research in theoretical computer science
    broadly connected to <em class="font-serif text-[110%] leading-[100%]">complexity theory</em>.
  </p>

  <p class="text-lg">
    If you find something interesting,
    <a class="link" href="mailto:maloaizav@gmail.com?subject=Research"
      >let me know</a
    >!
  </p>
</section>
